...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
 // tem acesso a tudo do modulo validaCPF>
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function formatCPF(cpf) {
      ...
      // fatiar cpf e adicionar no meio das fatias '.'
    ...
    value: function geraNovoCpf() {
      var cpfSemDigito = this.rand(); // gera numero aleatorio de 9 digitos
      var digito1 = _ValidaCPF_js__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(cpfSemDigito); // passa cpf aleatorio para gera digito o método estatico gera digito
      var digito2 = _ValidaCPF_js__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(cpfSemDigito + digito1); // mandamos cpf sem digito, acrescentado do seu primeiro digot
      var novoCpf = cpfSemDigito + digito1 + digito2; // cria novo cpf
...
`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,iCAAiC;EACjC,sCAAsC;;AAExC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,uBAAuB;EACvB,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,kBAAkB;AACpB;AACA;GACG,YAAY;EACb,wBAAwB;EACxB,YAAY;EACZ,kBAAkB;EAClB,eAAe;EACf,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,YAAY;AACd;;;AAGA;EACE,kBAAkB;EAClB,qBAAqB;AACvB;;AAEA;EACE,cAAc;EACd,aAAa;EACb,kBAAkB;EAClB,iBAAiB;EACjB,mBAAmB;EACnB,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,UAAU;AACZ;;AAEA;EACE,eAAe;EACf,sBAAsB;AACxB","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n  \n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  background-color: black;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\ninput {\n  padding: 5px;\n  border-radius: 3px;\n}\nbutton {\n   color: white;\n  background-color: purple;\n  padding: 9px;\n  border-radius: 7px;\n  cursor: pointer;\n  border: none;\n}\n\nbutton:hover {\n  opacity: 0.7;\n  color: black;\n}\n\n\n.container h1 {\n  text-align: center;\n  margin-bottom: center;\n}\n\n.cpf-gerado {\n  font-size: 2em;\n  color: purple;\n  text-align: center;\n  font-weight: bold;\n  margin-bottom: 40px;\n  letter-spacing: 3px;\n}\n\n.error {\n  font-size: 20px;\n  color: red;\n}\n\n.ok {\n  font-size: 20px;\n  color: rgb(5, 201, 93);\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_ValidaCPF__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/ValidaCPF */ "./src/modules/ValidaCPF.js");
 // tem acesso a tudo do modulo geraCPF
...
function executaValidacao(e) {
  ...
  var validaCpf = new _modules_ValidaCPF__WEBPACK_IMPORTED_MODULE_2__["default"](cpf); // manda o cpf do input para o construtor de validaCPF
...
function gerarCPF(e) {
  e.preventDefault();
  var gera = new _modules_GeraCPF__WEBPACK_IMPORTED_MODULE_0__["default"](); // instanciando novo objeto da classe GeraCPF, temos acesso aos seus metodos por meio de "gera"
  var cpfGerado = document.querySelector('.cpf-gerado');

  // caso esteja marcada(checked)
  if (formatarCheckbox.checked) {
    var cpf = gera.geraNovoCpf(); // gera um cpf sem formatação
...
var formatarCheckbox = document.querySelector('#formatarCPF');
